...
#include "interfaces/msg/detail/motor_command__rosidl_typesupport_fastrtps_c.h"
...
using _MotorCommand__ros_msg_type = interfaces__msg__MotorCommand;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_interfaces__msg__MotorCommand(
  const interfaces__msg__MotorCommand * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_deserialize_interfaces__msg__MotorCommand(
  eprosima::fastcdr::Cdr & cdr,
  interfaces__msg__MotorCommand * ros_message)
{
  // Field name: vel
  {
    size_t size = 22;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__MotorCommand;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_key_interfaces__msg__MotorCommand(
  const interfaces__msg__MotorCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: vel
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_key_interfaces__msg__MotorCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorCommand__ros_msg_type * ros_message = static_cast<const _MotorCommand__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_key_interfaces__msg__MotorCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const interfaces__msg__MotorCommand * ros_message = static_cast<const interfaces__msg__MotorCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_interfaces__msg__MotorCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  interfaces__msg__MotorCommand * ros_message = static_cast<interfaces__msg__MotorCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_interfaces__msg__MotorCommand(cdr, ros_message);
}

static uint32_t _MotorCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__MotorCommand(
...
static size_t _MotorCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__MotorCommand(
