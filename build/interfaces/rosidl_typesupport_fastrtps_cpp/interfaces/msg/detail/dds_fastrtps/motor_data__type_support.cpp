...
#include "interfaces/msg/detail/motor_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::MotorData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::MotorData & ros_message)
{
  // Member: pos
  {
    cdr >> ros_message.pos;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::MotorData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::MotorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::MotorData *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_MotorData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, MotorData)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_MotorData__handle;
}
