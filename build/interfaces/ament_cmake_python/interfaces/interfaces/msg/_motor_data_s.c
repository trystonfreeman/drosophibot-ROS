...
bool interfaces__msg__motor_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._motor_data.MotorData", full_classname_dest, 36) == 0);
  }
  interfaces__msg__MotorData * ros_message = _ros_message;
  {  // pos
  ...
  {  // torque
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_INT32);
      Py_ssize_t size = 22;
      int32_t * dest = ros_message->torque;
      for (Py_ssize_t i = 0; i < size; ++i) {
        int32_t tmp = *(npy_int32 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(int32_t));
      }
...
PyObject * interfaces__msg__motor_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._motor_data");
  ...
  {  // torque
    ...
    assert(sizeof(npy_int32) == sizeof(int32_t));
    npy_int32 * dst = (npy_int32 *)PyArray_GETPTR1(seq_field, 0);
    int32_t * src = &(ros_message->torque[0]);
    memcpy(dst, src, 22 * sizeof(int32_t));
    Py_DECREF(field);
  }
