...
bool interfaces__msg__motor_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._motor_command.MotorCommand", full_classname_dest, 42) == 0);
  }
  interfaces__msg__MotorCommand * ros_message = _ros_message;
  {  // vel
...
PyObject * interfaces__msg__motor_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._motor_command");
  ...
  {  // vel
    ...
    int32_t * src = &(ros_message->vel[0]);
    memcpy(dst, src, 22 * sizeof(int32_t));
    Py_DECREF(field);
  }
  {  // pos
    PyObject * field = NULL;
